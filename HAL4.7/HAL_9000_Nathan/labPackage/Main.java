...
public class Main {
	...
	private static final String SERVER_IP = "192.168.43.125"; //"localhost";
...
//			} else {
//				System.out.print("Transmission read");
//				
//				
//			}
//		} else {
...
//		}
		...
		//USLocalizer usl = new USLocalizer( odo, sampleProvider1, usData1,sampleProvider2, usData2, USLocalizer.LocalizationType.FALLING_EDGE, t.get("SC"));
...
//		case 2:
//			lightLocalTarget = new double[] {30.96 * 10.0, 0.0};
//		case 3:4
//			lightLocalTarget = new double[] {30.95 * 10.0, 30.96 * 10.0};
//		case 4:
//			lightLocalTarget = new double[] {0.0, 10.96 * 10.0};
//		}
		lsl.doLocalization(30.96, 30.96);
		Button.waitForAnyPress();
//		nav.travelTo(15,15);
//		
//		driver.start();
