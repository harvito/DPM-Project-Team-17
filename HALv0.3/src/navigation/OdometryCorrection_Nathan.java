...
public class OdometryCorrection_Nathan extends Thread{
	...
	public OdometryCorrection_Nathan(Navigation nav, RegulatedMotor usMotor, int xSquare, int ySquare, Odometer odometer, SampleProvider colorValue, float[] colorData, EV3ColorSensor colorSensor){
		this.nav = nav;
