...
/**A tracker for where the robot is on the field, using a Cartesian coordinate system
 * uses a timer and motor tachometers to regularly update value
 *
 */
public class Odometer implements TimerListener {
	...
	public Odometer (EV3LargeRegulatedMotor leftMotor, EV3LargeRegulatedMotor rightMotor, int INTERVAL, boolean autostart) {
		...
		this.navigate = new Navigation(this, leftMotor, rightMotor);
